import{S as e}from"./StrategicGlobeEngine-0gPIyKMi.js";import{s as J,m as K,d as ee,a as ie,l as te}from"./logDepthDeclaration-DOWwfjS9.js";import{h as oe}from"./helperFunctions-CMMtlwRE.js";import{c as re,f as ae,a as ne,b as le}from"./fogFragment-B2muaR6M.js";import"./index-BC7nVnez.js";const t="decalFragmentDeclaration",A=`#ifdef DECAL
...
`;e.ShadersStore[x]||(e.ShadersStore[x]=Q);const Ne=[se,fe,J,K,ee,de,ce,ie,oe,ve,he,ue,pe,me,ge,Se,Ee,Ce,De,Te,Le,Ie,we,re,te,ae,ne,xe,Ae,Pe,Re,Xe,le,Fe];for(const i of Ne)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const Ue={name:x,shader:Q};export{Ue as defaultPixelShader};
