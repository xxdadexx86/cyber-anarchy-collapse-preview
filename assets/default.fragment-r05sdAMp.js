import{S as e}from"./StrategicGlobeEngine-CTOxoX25.js";import{s as Y,m as $,d as q,a as j,l as Z}from"./logDepthDeclaration-uNqyZFMD.js";import{h as Q}from"./helperFunctions-wihAb8fj.js";import{c as J,f as K,a as ee,b as re}from"./fogFragment-DdBfpNKE.js";import"./index-DW9Nw5Jc.js";const t="prePassDeclaration",E=`#ifdef PREPASS
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=y);const de={name:d,shader:y},c="reflectionFunction",N=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=N);const ce={name:c,shader:N},v="imageProcessingDeclaration",F=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=F);const ve={name:v,shader:F},u="imageProcessingFunctions",M=`#if TONEMAPPING==3
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=W);const me={name:m,shader:W},S="bumpFragment",U=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=U);const Se={name:S,shader:U},g="decalFragment",z=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=z);const ge={name:g,shader:z},x="depthPrePass",G=`#ifdef DEPTHPREPASS
...
`;e.ShadersStoreWGSL[C]||(e.ShadersStoreWGSL[C]=B);const Ce=[Y,$,q,te,ae,j,Q,ie,oe,fe,ne,se,le,de,ce,ve,ue,pe,he,me,J,Z,K,ee,Se,ge,xe,Te,Le,re,we];for(const r of Ce)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const Xe={name:C,shader:B};export{Xe as defaultPixelShaderWGSL};
